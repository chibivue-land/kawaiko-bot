...
const 目のあるモデル: 読み取り専用配列<文字列> = [
  // 普段の先頭のモデル．Cloudflare の一覧で Vision と明記されていて，入力の
  // 形も同じ (content の配列に image_url)．ここに載せ忘れていたあいだ，本番の
  // モデル一覧で目があるのは Gemini だけで，それが転ぶと「画像を解説して」に
  // 画像抜きで答えていた (2026-09-21)．
