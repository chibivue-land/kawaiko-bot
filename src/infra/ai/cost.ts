import { Temporal, nowInstant } from "../../domain/time";
...
/** Month key like "2026-08" (UTC), the bucket the budget guard counts into. */
export function monthKey(now: Temporal.Instant = nowInstant()): string {
