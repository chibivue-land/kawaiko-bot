...
- 乱心の頻度: `乱心の確率` (既定 0.05)．雑談への返事・独言・横槍でだけ賽を振る．正解のある問いの最中には乱心しない．文面は [源/核/機嫌-乱心.md](源/核/機嫌-乱心.md)
...
| 使いどころ     | 訊くこと                                              | 効き方                                                                                                   |
| -------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| 名指しの見立て | どれだけ考える必要があるか / 外へ裏を取りに行くべきか | 構え (反射・普通・熟考) を決める．熟考なら賢いモデル + 思考つき + 口調のダイヤル無し．調査の要否も決める |
